...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-ABOU"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "aboubackykane2022"      # mettre le nom du compte de stockage créer dans le lab 1
